        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-6 relative z-20">
            <button 
              ...
              disabled={isPending}
              className="w-full flex items-center justify-center gap-2 py-3 bg-white/[0.02] border border-white/8 hover:border-white/15 hover:bg-white/[0.05] rounded-xl text-sm font-semibold text-gray-300 hover:text-white transition-all cursor-pointer disabled:opacity-50" 
